...
Runs recorded: 121 · receipts: 1307 (MEASURED from files present; cron is best-effort, gaps are honest)

Track record (latest, MEASURED from verified receipts only): +1d n=0 hit=— pending=0 · +7d n=0 hit=— pending=0 · no-calls(BLOCKED)=375 — a past frequency, NOT a prediction

Hash chain: 119 link(s), head seq 119 sha256 b390f4f4ceba… — every sealed run tamper-evident; walk it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --chain ledger/`

Paper book (MODELED, paper-only — NOT real funds): seq 113 · equity $10000.000000 · open positions 0 · fills this run 0 · replay it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --book ledger/`

Refusal record (MEASURED): latest run BLOCKED 1/6 — liquidity×1 · lifetime (recorded runs) 340/672 — liquidity×225 conviction×126 · a refusal is a decision, not an absence · replay: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --refusals ledger/`

External witness (REPORTED, SET + Merkle inclusion + log consistency offline-verifiable): chain head seq 119 anchored in Rekor — logIndex 2433465633, uuid 108e9186e8c5677a… · heads anchored 119/119 · inclusion proven offline 119/119 · log consistency 118/118 adjacent checkpoint pair(s) receipted · second witness (RFC 3161) 119/119 head(s) countersigned · cross-witness gossip 106 observation(s) from a second scheduled observer · an anchored head cannot be silently truncated · check: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --witness .`
