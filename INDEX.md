...
Runs recorded: 152 · receipts: 1648 (MEASURED from files present; cron is best-effort, gaps are honest)

Track record (latest, MEASURED from verified receipts only): +1d n=0 hit=— pending=0 · +7d n=0 hit=— pending=0 · no-calls(BLOCKED)=446 — a past frequency, NOT a prediction

Hash chain: 150 link(s), head seq 150 sha256 6a6db353178d… — every sealed run tamper-evident; walk it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --chain ledger/`

Paper book (MODELED, paper-only — NOT real funds): seq 144 · equity $10000.000000 · open positions 0 · fills this run 0 · replay it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --book ledger/`

Refusal record (MEASURED): latest run BLOCKED 1/6 — liquidity×1 · lifetime (recorded runs) 411/858 — liquidity×293 conviction×129 · a refusal is a decision, not an absence · replay: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --refusals ledger/`

External witness (REPORTED, SET + Merkle inclusion + log consistency offline-verifiable): chain head seq 150 anchored in Rekor — logIndex 2524073614, uuid 108e9186e8c5677a… · heads anchored 150/150 · inclusion proven offline 150/150 · log consistency 149/149 adjacent checkpoint pair(s) receipted · second witness (RFC 3161) 150/150 head(s) countersigned · cross-witness gossip 137 observation(s) from a second scheduled observer · an anchored head cannot be silently truncated · check: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --witness .`
