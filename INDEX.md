...
Runs recorded: 177 · receipts: 1917 (MEASURED from files present; cron is best-effort, gaps are honest)

Track record (latest, MEASURED from verified receipts only): +1d n=0 hit=— pending=0 · +7d n=0 hit=— pending=0 · no-calls(BLOCKED)=503 — a past frequency, NOT a prediction

Hash chain: 175 link(s), head seq 175 sha256 e255847f6d57… — every sealed run tamper-evident; walk it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --chain ledger/`

Paper book (MODELED, paper-only — NOT real funds): seq 169 · equity $10000.000000 · open positions 0 · fills this run 0 · replay it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --book ledger/`

Refusal record (MEASURED): latest run BLOCKED 2/6 — liquidity×2 · lifetime (recorded runs) 468/1002 — liquidity×341 conviction×138 · a refusal is a decision, not an absence · replay: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --refusals ledger/`

External witness (REPORTED, SET + Merkle inclusion + log consistency offline-verifiable): chain head seq 175 anchored in Rekor — logIndex 2597684105, uuid 108e9186e8c5677a… · heads anchored 175/175 · inclusion proven offline 175/175 · log consistency 174/174 adjacent checkpoint pair(s) receipted · second witness (RFC 3161) 175/175 head(s) countersigned · cross-witness gossip 162 observation(s) from a second scheduled observer · an anchored head cannot be silently truncated · check: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --witness .`
