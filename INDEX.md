...
Runs recorded: 105 · receipts: 1131 (MEASURED from files present; cron is best-effort, gaps are honest)

Track record (latest, MEASURED from verified receipts only): +1d n=0 hit=— pending=0 · +7d n=0 hit=— pending=0 · no-calls(BLOCKED)=352 — a past frequency, NOT a prediction

Hash chain: 103 link(s), head seq 103 sha256 0fad1a548af9… — every sealed run tamper-evident; walk it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --chain ledger/`

Paper book (MODELED, paper-only — NOT real funds): seq 97 · equity $10000.000000 · open positions 0 · fills this run 0 · replay it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --book ledger/`

Refusal record (MEASURED): latest run BLOCKED 2/6 — liquidity×2 · lifetime (recorded runs) 317/576 — liquidity×203 conviction×125 · a refusal is a decision, not an absence · replay: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --refusals ledger/`

External witness (REPORTED, SET + Merkle inclusion + log consistency offline-verifiable): chain head seq 103 anchored in Rekor — logIndex 2380640892, uuid 108e9186e8c5677a… · heads anchored 103/103 · inclusion proven offline 103/103 · log consistency 102/102 adjacent checkpoint pair(s) receipted · second witness (RFC 3161) 103/103 head(s) countersigned · cross-witness gossip 90 observation(s) from a second scheduled observer · an anchored head cannot be silently truncated · check: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --witness .`
