...
Runs recorded: 170 · receipts: 1846 (MEASURED from files present; cron is best-effort, gaps are honest)

Track record (latest, MEASURED from verified receipts only): +1d n=0 hit=— pending=0 · +7d n=0 hit=— pending=0 · no-calls(BLOCKED)=488 — a past frequency, NOT a prediction

Hash chain: 168 link(s), head seq 168 sha256 93f41040afd4… — every sealed run tamper-evident; walk it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --chain ledger/`

Paper book (MODELED, paper-only — NOT real funds): seq 162 · equity $10000.000000 · open positions 0 · fills this run 0 · replay it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --book ledger/`

Refusal record (MEASURED): latest run BLOCKED 3/6 — liquidity×2 conviction×1 · lifetime (recorded runs) 453/966 — liquidity×329 conviction×135 · a refusal is a decision, not an absence · replay: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --refusals ledger/`

External witness (REPORTED, SET + Merkle inclusion + log consistency offline-verifiable): chain head seq 168 anchored in Rekor — logIndex 2581057960, uuid 108e9186e8c5677a… · heads anchored 168/168 · inclusion proven offline 168/168 · log consistency 167/167 adjacent checkpoint pair(s) receipted · second witness (RFC 3161) 168/168 head(s) countersigned · cross-witness gossip 155 observation(s) from a second scheduled observer · an anchored head cannot be silently truncated · check: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --witness .`
