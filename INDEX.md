...
Runs recorded: 110 · receipts: 1186 (MEASURED from files present; cron is best-effort, gaps are honest)

Track record (latest, MEASURED from verified receipts only): +1d n=0 hit=— pending=0 · +7d n=0 hit=— pending=0 · no-calls(BLOCKED)=363 — a past frequency, NOT a prediction

Hash chain: 108 link(s), head seq 108 sha256 6ec8a237b397… — every sealed run tamper-evident; walk it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --chain ledger/`

Paper book (MODELED, paper-only — NOT real funds): seq 102 · equity $10000.000000 · open positions 0 · fills this run 0 · replay it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --book ledger/`

Refusal record (MEASURED): latest run BLOCKED 2/6 — liquidity×2 · lifetime (recorded runs) 328/606 — liquidity×214 conviction×125 · a refusal is a decision, not an absence · replay: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --refusals ledger/`

External witness (REPORTED, SET + Merkle inclusion + log consistency offline-verifiable): chain head seq 108 anchored in Rekor — logIndex 2394597271, uuid 108e9186e8c5677a… · heads anchored 108/108 · inclusion proven offline 108/108 · log consistency 107/107 adjacent checkpoint pair(s) receipted · second witness (RFC 3161) 108/108 head(s) countersigned · cross-witness gossip 95 observation(s) from a second scheduled observer · an anchored head cannot be silently truncated · check: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --witness .`
