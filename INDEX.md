...
Runs recorded: 127 · receipts: 1373 (MEASURED from files present; cron is best-effort, gaps are honest)

Track record (latest, MEASURED from verified receipts only): +1d n=0 hit=— pending=0 · +7d n=0 hit=— pending=0 · no-calls(BLOCKED)=383 — a past frequency, NOT a prediction

Hash chain: 125 link(s), head seq 125 sha256 388722ae6631… — every sealed run tamper-evident; walk it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --chain ledger/`

Paper book (MODELED, paper-only — NOT real funds): seq 119 · equity $10000.000000 · open positions 0 · fills this run 0 · replay it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --book ledger/`

Refusal record (MEASURED): latest run BLOCKED 1/6 — liquidity×1 · lifetime (recorded runs) 348/708 — liquidity×233 conviction×126 · a refusal is a decision, not an absence · replay: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --refusals ledger/`

External witness (REPORTED, SET + Merkle inclusion + log consistency offline-verifiable): chain head seq 125 anchored in Rekor — logIndex 2455274700, uuid 108e9186e8c5677a… · heads anchored 125/125 · inclusion proven offline 125/125 · log consistency 124/124 adjacent checkpoint pair(s) receipted · second witness (RFC 3161) 125/125 head(s) countersigned · cross-witness gossip 112 observation(s) from a second scheduled observer · an anchored head cannot be silently truncated · check: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --witness .`
