...
Runs recorded: 122 · receipts: 1318 (MEASURED from files present; cron is best-effort, gaps are honest)

Track record (latest, MEASURED from verified receipts only): +1d n=0 hit=— pending=0 · +7d n=0 hit=— pending=0 · no-calls(BLOCKED)=377 — a past frequency, NOT a prediction

Hash chain: 120 link(s), head seq 120 sha256 e32d684e0413… — every sealed run tamper-evident; walk it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --chain ledger/`

Paper book (MODELED, paper-only — NOT real funds): seq 114 · equity $10000.000000 · open positions 0 · fills this run 0 · replay it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --book ledger/`

Refusal record (MEASURED): latest run BLOCKED 2/6 — liquidity×2 · lifetime (recorded runs) 342/678 — liquidity×227 conviction×126 · a refusal is a decision, not an absence · replay: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --refusals ledger/`

External witness (REPORTED, SET + Merkle inclusion + log consistency offline-verifiable): chain head seq 120 anchored in Rekor — logIndex 2437252959, uuid 108e9186e8c5677a… · heads anchored 120/120 · inclusion proven offline 120/120 · log consistency 119/119 adjacent checkpoint pair(s) receipted · second witness (RFC 3161) 120/120 head(s) countersigned · cross-witness gossip 107 observation(s) from a second scheduled observer · an anchored head cannot be silently truncated · check: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --witness .`
