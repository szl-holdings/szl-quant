...
Runs recorded: 139 · receipts: 1505 (MEASURED from files present; cron is best-effort, gaps are honest)

Track record (latest, MEASURED from verified receipts only): +1d n=0 hit=— pending=0 · +7d n=0 hit=— pending=0 · no-calls(BLOCKED)=416 — a past frequency, NOT a prediction

Hash chain: 137 link(s), head seq 137 sha256 858dd24b13bc… — every sealed run tamper-evident; walk it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --chain ledger/`

Paper book (MODELED, paper-only — NOT real funds): seq 131 · equity $10000.000000 · open positions 0 · fills this run 0 · replay it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --book ledger/`

Refusal record (MEASURED): latest run BLOCKED 4/6 — liquidity×4 · lifetime (recorded runs) 381/780 — liquidity×263 conviction×129 · a refusal is a decision, not an absence · replay: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --refusals ledger/`

External witness (REPORTED, SET + Merkle inclusion + log consistency offline-verifiable): chain head seq 137 anchored in Rekor — logIndex 2491545110, uuid 108e9186e8c5677a… · heads anchored 137/137 · inclusion proven offline 137/137 · log consistency 136/136 adjacent checkpoint pair(s) receipted · second witness (RFC 3161) 137/137 head(s) countersigned · cross-witness gossip 124 observation(s) from a second scheduled observer · an anchored head cannot be silently truncated · check: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --witness .`
