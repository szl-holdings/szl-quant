...
Runs recorded: 147 · receipts: 1593 (MEASURED from files present; cron is best-effort, gaps are honest)

Track record (latest, MEASURED from verified receipts only): +1d n=0 hit=— pending=0 · +7d n=0 hit=— pending=0 · no-calls(BLOCKED)=437 — a past frequency, NOT a prediction

Hash chain: 145 link(s), head seq 145 sha256 c5bb1943eac2… — every sealed run tamper-evident; walk it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --chain ledger/`

Paper book (MODELED, paper-only — NOT real funds): seq 139 · equity $10000.000000 · open positions 0 · fills this run 0 · replay it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --book ledger/`

Refusal record (MEASURED): latest run BLOCKED 3/6 — liquidity×3 · lifetime (recorded runs) 402/828 — liquidity×284 conviction×129 · a refusal is a decision, not an absence · replay: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --refusals ledger/`

External witness (REPORTED, SET + Merkle inclusion + log consistency offline-verifiable): chain head seq 145 anchored in Rekor — logIndex 2506732575, uuid 108e9186e8c5677a… · heads anchored 145/145 · inclusion proven offline 145/145 · log consistency 144/144 adjacent checkpoint pair(s) receipted · second witness (RFC 3161) 145/145 head(s) countersigned · cross-witness gossip 132 observation(s) from a second scheduled observer · an anchored head cannot be silently truncated · check: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --witness .`
