...
Runs recorded: 116 · receipts: 1252 (MEASURED from files present; cron is best-effort, gaps are honest)

Track record (latest, MEASURED from verified receipts only): +1d n=0 hit=— pending=0 · +7d n=0 hit=— pending=0 · no-calls(BLOCKED)=370 — a past frequency, NOT a prediction

Hash chain: 114 link(s), head seq 114 sha256 8c5683363702… — every sealed run tamper-evident; walk it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --chain ledger/`

Paper book (MODELED, paper-only — NOT real funds): seq 108 · equity $10000.000000 · open positions 0 · fills this run 0 · replay it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --book ledger/`

Refusal record (MEASURED): latest run BLOCKED 1/6 — liquidity×1 · lifetime (recorded runs) 335/642 — liquidity×220 conviction×126 · a refusal is a decision, not an absence · replay: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --refusals ledger/`

External witness (REPORTED, SET + Merkle inclusion + log consistency offline-verifiable): chain head seq 114 anchored in Rekor — logIndex 2415354774, uuid 108e9186e8c5677a… · heads anchored 114/114 · inclusion proven offline 114/114 · log consistency 113/113 adjacent checkpoint pair(s) receipted · second witness (RFC 3161) 114/114 head(s) countersigned · cross-witness gossip 101 observation(s) from a second scheduled observer · an anchored head cannot be silently truncated · check: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --witness .`
