...
Runs recorded: 153 · receipts: 1659 (MEASURED from files present; cron is best-effort, gaps are honest)

Track record (latest, MEASURED from verified receipts only): +1d n=0 hit=— pending=0 · +7d n=0 hit=— pending=0 · no-calls(BLOCKED)=447 — a past frequency, NOT a prediction

Hash chain: 151 link(s), head seq 151 sha256 5c42c04d5072… — every sealed run tamper-evident; walk it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --chain ledger/`

Paper book (MODELED, paper-only — NOT real funds): seq 145 · equity $10000.000000 · open positions 0 · fills this run 0 · replay it: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --book ledger/`

Refusal record (MEASURED): latest run BLOCKED 1/6 — liquidity×1 · lifetime (recorded runs) 412/864 — liquidity×294 conviction×129 · a refusal is a decision, not an absence · replay: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --refusals ledger/`

External witness (REPORTED, SET + Merkle inclusion + log consistency offline-verifiable): chain head seq 151 anchored in Rekor — logIndex 2527839360, uuid 108e9186e8c5677a… · heads anchored 151/151 · inclusion proven offline 151/151 · log consistency 150/150 adjacent checkpoint pair(s) receipted · second witness (RFC 3161) 151/151 head(s) countersigned · cross-witness gossip 138 observation(s) from a second scheduled observer · an anchored head cannot be silently truncated · check: `node verify/verify.mjs --pubkey keys/engine_pubkey.json --witness .`
